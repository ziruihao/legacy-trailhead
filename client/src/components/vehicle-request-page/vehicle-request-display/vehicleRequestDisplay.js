      ...
      return (
        <>
          ...
          {assignment.assigned_vehicle.name === 'Enterprise'
            ...
            : <Text type='p1'>{utils.dates.formatDate(new Date(assignment.assigned_pickupDateAndTime), { weekday: true })} @ {utils.dates.formatTime(new Date(assignment.assigned_pickupDateAndTime), { timezone: true })}</Text>
      }
          <Stack size={25} />
          ...
          {assignment.assigned_vehicle.name === 'Enterprise'
            ? <Text type='p1' color='gray3'>N/A</Text>
            : <Text type='p1'>{utils.dates.formatDate(new Date(assignment.assigned_returnDateAndTime), { weekday: true })} @ {utils.dates.formatTime(new Date(assignment.assigned_returnDateAndTime), { timezone: true })}</Text>
          }
          <Stack size={25} />
        </>
      );
      ...
      <>
        ...
        <Box dir='row'>
          <Box dir='col' expand>
            ...
            <Stack size={25} />
            <Text type='p1'>{utils.dates.formatDate(new Date(vehicle.pickupDateAndTime), { weekday: true })} @ {utils.dates.formatTime(new Date(vehicle.pickupDateAndTime), { timezone: true })}</Text>
            <Stack size={25} />
            <Text type='h3'>Return</Text>
            <Stack size={25} />
            <Text type='p1'>{utils.dates.formatDate(new Date(vehicle.returnDateAndTime), { weekday: true })} @ {utils.dates.formatTime(new Date(vehicle.returnDateAndTime), { timezone: true })}</Text>
            <Stack size={25} />
          </Box>
          <Box dir='col' expand>
