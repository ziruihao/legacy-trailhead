...
class LeaderTripDetails extends Component {
  ...
  getPending = () => {
    if (this.props.trip.pending.length === 0) {
      return (
          ...
          <div>
            ...
            <div className="emails">
              <Form className="col-9">
                <Form.Control ref={pendingEmail => this.pendingEmail = pendingEmail} as="textarea" value={this.state.pendingEmail} name="pendingEmail" onChange={this.onTextChange} />
              </Form>
              <button type="button" className="signup-button leader-signup-button copy-button" onClick={this.copyPendingToClip}>Copy</button>
            </div>
          </div>
        </div>
      );
  ...
  getPendingRows = () => {
    return this.props.trip.pending.map(pender => (
      <div key={pender._id} className="leader-detail-row">
        ...
        <button type="button" className="signup-button leader-signup-button" onClick={() => this.moveToTrip(pender)}>Move to trip</button>
      </div>
    ));
  }
      ...
      return (
        <div className="leader-details-container">
          ...
          <div className="on-trip">
            <h2>On trip ({this.props.trip.members.length})</h2>
            <div className="trip-detail">
              {this.getOnTrip()}
            </div>
          </div>
          ...
          <div className="pending">
            <h2>Pending ({this.props.trip.pending.length})</h2>
            <div className="trip-detail">
              {this.getPending()}
            </div>
          </div>
          ...
          <div className="center">
            <Link to={`/edittrip/${this.props.trip.id}`} className="signup-button"><button type="submit" className="signup-button">Edit Trip</button></Link>
          </div>

          <div className="center">
            <span className="cancel-link" onClick={this.showModal} role="button" tabIndex={0}>Delete trip</span>
          </div>
          ...
          >
            ...
            <button type="submit" className="leader-cancel-button confirm-cancel" onClick={this.deleteTrip}>It be like that sometimes</button>
